...
keggresids <- substr(rownames(pathwaySubset$DCM_Male_African.American$KEGGResults), 6, 13)
foldchanges <- pathwaySubset$DCM_Male_African.American$DEAResults$results$logFC_DonorVsDCM
